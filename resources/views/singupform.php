    ...
    <form class="form" method="POST" >
        <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input required  name="location" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            <div id="emailHelp" class="form-text"></div>
          </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input required  name="nid" type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            <div id="emailHelp" class="form-text"></div>
          </div>
        <div class="mb-3">
      ...
      <?php
        ...
        if(isset($_POST['submit']))
        {
          ...
          $u=new users;
          $u->adduser($_POST['fname'],$_POST['lname'],$_POST['email'],$_POST['location'],$_POST['password'],$_POST['nid'],$_POST['phone'],$_POST['age']);
          setcookie("logintohospital",1,strtotime("+30 day"));
        }
       ?>
